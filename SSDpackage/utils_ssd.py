...
class BBoxUtility(object):
    ...
    def __init__(self, num_classes, priors=None, overlap_threshold=0.5,
        ...
        self._top_k = top_k
        self.boxes = tf2.placeholder(dtype='float32', shape=(None, 4))
        self.scores = tf2.placeholder(dtype='float32', shape=(None,))
        self.nms = tf.image.non_max_suppression(self.boxes, self.scores,
                                                self._top_k,
                                                iou_threshold=self._nms_thresh)
        self.sess = tf2.Session(config=tf2.ConfigProto(device_count={'GPU': 0}))
